            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="single_photography" style="background: url(<?php echo base_url('upload/content/'.$konten->gambar) ?>);" >
                        <a href="<?php echo base_url('mainboard/berita')?>"><?php echo $konten->no ?></a>
                        <div class="info">
                            <div class="info_inner">
                                <h3><a href="<?php echo base_url('mainboard/berita/'. $konten->no)?>"><?php echo $konten->judul ?></a></h3>
                ...
                <div class="col-xl-12">
                    <div class="photoslider_active owl-carousel">
                        <div class="single_photography">
                            <img src="<?php echo base_url(); ?>asset/img/photography/single-1.jpg" alt="">
                            <div class="photo_title">
                                <h4>Photography</h4>
                            </div>
                        </div>
                        <div class="single_photography">
                            <img src="<?php echo base_url(); ?>asset/img/photography/single-2.jpg" alt="">
                            <div class="photo_title">
                                <h4>Travel Shot</h4>
                            </div>
                        </div>
                        <div class="single_photography">
                            <img src="<?php echo base_url(); ?>asset/img/photography/single-3.jpg" alt="">
                            <div class="photo_title">
                                <h4>Photoshop</h4>
                            </div>
                        </div>
                        <div class="single_photography">
                            <img src="<?php echo base_url(); ?>asset/img/photography/single-4.jpg" alt="">
                            <div class="photo_title">
                                <h4>Lens</h4>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/1.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                                    <p><a href="#">Photography I 24 May 2019</a></p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                                    <p><a href="#">Photography I 24 May 2019</a></p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                                    <p><a href="#">Photography I 24 May 2019</a></p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/5.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                                    <p><a href="#">Photography I 24 May 2019</a></p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single_blog">
                                <div class="blog_thumb">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>asset/img/most_recent/6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="blog_meta">
                                    <p><a href="#">Photography I 24 May 2019</a></p>
