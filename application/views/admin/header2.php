...
<head>
    ...
    <title>Blogs - Contents</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- <link rel="manifest" href="site.webmanifest"> -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>asset../img/favicon.png">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-md-4 d-none d-md-block">
                            <div class="header_links ">
                                <ul>
                                    ...
                                    <li><a class="twiter" href="https://twitter.com/explore"> <i class="fa fa-twitter"></i> </a></li>
                        ...
                        <div class="col-xl-4 col-md-4 d-none d-md-block">
                            <div class="login_resiter">
                                <p><a href="<?php echo base_url('login/logout')?>"><i class="flaticon-user"></i>logout</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="<?php echo base_url('admin/content')?>">Tabel Konten</a></li>
                                        <li><a href="<?php echo base_url('admin/user')?>">Tabel User</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
